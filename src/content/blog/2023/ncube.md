...
pubDate: 2023-11-16T09:55:29-08:00
...
<div class="video-embed">
  <iframe
    src="https://www.youtube-nocookie.com/embed/eoXn6nwV694"
    title="Perspective projection tutorial by Carl the Person"
    loading="lazy"
...
$$
x_p = \frac{x}{z \tan\left(\frac{\theta}{2}\right)}
$$

$$
y_p = \frac{y}{z \tan\left(\frac{\theta}{2}\right)}
$$
...
presses the arrows keys, the application updates the
$(x_{\text{cursor}},
y_{\text{cursor}})$ location of the cursor accordingly. The
cursor location is later used to determine the roll and pitch angles using the
following formulas:

$$
\beta = \frac{x_{\text{cursor}}}{s_{\text{width}}} \times \pi
$$

$$
\gamma = \frac{y_{\text{cursor}}}{s_{\text{height}}} \times \pi
$$

Where $s_{\text{width}}$ and $s_{\text{height}}$ are the screen width/height.
...
![Cube With Edges](/posts/2023/ncube/cube-with-edges.webp)

Now compare that with a capture of your cube in a similar orientation:

![Cube Without Edges](/posts/2023/ncube/cube-without-edges.webp)
...
![Cube With Generated Edges](/posts/2023/ncube/cube-with-generated-edges.webp)
...
<div class="video-embed">
  <video controls preload="auto">
    <source src="/posts/2023/ncube/ncube-demo.mp4" type="video/mp4">
