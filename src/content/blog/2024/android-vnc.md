...
pubDate: 2024-10-12T12:04:29-04:00
...
![Xfinity Port
Fowarding](/posts/2024/android-vnc/xfinity-port-fwding.webp)
...
7. In the Pubkeys page, unlock your key by tapping it until the icon changes to
   ...
   "Copy public key."
   ![ConnectBot
Pubkey](/posts/2024/android-vnc/connectbot-pubkey.webp)
...
9. Back on the Android device, verify you can login to your PC via ConnectBot.
   ...
   below. ![ConnectBot
Session](/posts/2024/android-vnc/connectbot-session.webp)
...
11. Add a new port forwarding rule with type set to "Local," source port set to
    ...
    ![ConnectBot Port
Fwding](/posts/2024/android-vnc/connectbot-port-fwd.webp)
...
2. Fill out the following fields. Set "Nickname" to whatever you would like to
   ...
   their defaults.
   ![androidVNC Config](/posts/2024/android-vnc/androidvnc-config.webp)
...
4. You should see your PC desktop loading. The first frame may take awhile to
   load. ![OSRS VNC](/posts/2024/android-vnc/osrs-vnc.webp)

After following the steps, did you get the following error message?

![androidVNC Connection Error](/posts/2024/android-vnc/androidvnc-conn-err.webp)
...
[4]:
  https://play.google.com/store/apps/details?id=net.christianbeier.droidvnc_ng&hl=en_US
