---
title: "Caesar Cipher"
pubDate: 2024-04-09T15:42:10-07:00
...
$(2 - 14) \mod 26 = 14$ which maps to the letter "o."

In general, the encryption and decryption formulas are:

$$
E_n(x) = (x + n) \bmod |\Sigma|
$$

$$
D_n(x) = (x - n) \bmod |\Sigma|
$$
...
[![ASCII Table](/posts/2024/caesar-cipher/ascii-table.webp)][4]
...
between two vectors to get a measure of how similar they are. The formula looks
like this:
...
![Frequency Plot](/posts/2024/caesar-cipher/frequency-plot.webp)
