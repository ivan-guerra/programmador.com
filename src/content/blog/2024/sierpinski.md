...
pubDate: 2024-02-07T15:39:59-08:00
...
The space complexity is $\mathcal{O}(degree)$ due to the depth of the call stack
scaling linearly with the degree.
...
$\mathcal{O}(\text{max\_iterations})$. A linear algorithm that scales with a
...
<div class="video-embed">
  <video controls preload="auto">
    <source
      src="/posts/2024/sierpinski/sierpinski.mp4"
      type="video/mp4"
    />
  </video>
</div>
