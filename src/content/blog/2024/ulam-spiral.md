---
title: "Ulam Spiral"
pubDate: 2024-05-02T14:32:27-05:00
...
$\mathcal{O}(\sqrt{N} \times N^2) = \mathcal{O}(N^{2.5})$! Using the sieve
approach reduces the time complexity to $\mathcal{O}(N^2)$. Why? The primality
check in the main loop gets reduced to an $\mathcal{O}(1)$ time lookup into a
precomputed set of prime numbers. The space complexity remains linear though the
constant hidden by the big O notation does grow.
...
Method](/posts/2024/ulam-spiral/sieve-vs-sqrt.webp)
...
![Ulam Spiral 1024](/posts/2024/ulam-spiral/uspiral-1024.webp)
