---
title: "Plasma"
pubDate: 2025-02-13T10:48:16-05:00
...
![FRACTINT Plasma](/posts/2025/plasma/fractint.gif)
...
![Sine](/posts/2025/plasma/sine.webp)
...
![Ripple](/posts/2025/plasma/ripples.webp)
...
![Spiral](/posts/2025/plasma/spiral.webp)
...
![Circle](/posts/2025/plasma/circles.webp)
...
$$
f(d, t, s, p_x, p_y, d_{\min})
= \sin\left(\frac{s p_x}{d_{\min}}\right)
  \sin\left(\frac{s p_y}{d_{\min}} + t\right)
$$

![Checkerboard](/posts/2025/plasma/checkerboard.webp)
...
`hsv_to_rgb()` function expects the hue to be in the range \([0, 360]\). The
code maps the plasma value to the hue range of the desired palette. For example,
a rainbow palette covers the full range of hues. In contrast, the blue/cyan
...
<div class="video-embed">
  <video src="/posts/2025/plasma/demo.mp4" controls preload="auto">
