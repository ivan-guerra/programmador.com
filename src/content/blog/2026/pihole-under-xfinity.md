...
pubDate: 2026-07-04T15:16:58-04:00
...
![Xfinity App Gateway Admin Tool](/posts/2026/pihole-under-xfinity/xinfinity-app.webp)
...
![Xfinity Admin Web Portal DHCP Settings](/posts/2026/pihole-under-xfinity/xinfinity-web-app.webp)
...
2. If you have port forwarding rules, jot down the rules and remove them. You
   ...
   ![Xfinity App Port Forwarding](/posts/2026/pihole-under-xfinity/port-fwding.webp)
...
3. From the Xfinity app, select each "Disconnected Device" individually and
   ...
   ![Xfinity App Forget](/posts/2026/pihole-under-xfinity/forget-device.webp)
...
4. From the Xfinity admin portal, navigate to "Gateway -> Connected Devices."
   ...
   ![Xfinity Admin Web Portal Reserve IP](/posts/2026/pihole-under-xfinity/reserve-ip.webp)
...
6. From the Pi-hole admin web portal, navigate to "Settings -> DHCP." Enable the
   ...
   ![Pi-hole DHCP Setup](/posts/2026/pihole-under-xfinity/pihole-dhcp.webp)
